                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <a class="dropdown-item" href="#">1/1(a)</a>
                                <a class="dropdown-item" href="#">1/1(b)</a>
                                <a class="dropdown-item" href="#">1/2(a)</a>
                                <a class="dropdown-item" href="#">1/2(b)</a>
                                <a class="dropdown-item" href="#">2/1</a>
                                <a class="dropdown-item" href="#">2/2</a>
                                <a class="dropdown-item" href="#">3/1</a>
                                <a class="dropdown-item" href="{{ url('/routine') }}">3/2</a>
